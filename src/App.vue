...
<template>
  <div class="container w-full">
    <header class="bg-[#539DD3] h-16 flex items-center px-4 justify-center">
      <img class="h-10 w-10 mr-2" src="./assets/battery.svg" alt="">
    ...
    <button class="fixed bottom-0 left-0 bg-[#539DD3] w-full h-12 font-bold text-white rounded-2xl">
      КОРЗИНА
    </button>
  </div>
